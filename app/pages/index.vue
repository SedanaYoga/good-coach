      ...
      <div class="flex flex-col gap-6">
        ...
        <UiCard>
          <UiCardHeader>
            <div class="flex justify-between items-center">
              ...
              <span
                ...
                v-if="dashboardData.nextWorkout?.calculated_date"
                >{{
                  formatDate(
                    dashboardData.nextWorkout.calculated_date,
                    'ddd, MMM DD',
                  )
                }}</span
              >
          ...
          <UiCardContent>
            ...
            >
              <div
                class="text-3xl bg-muted w-14 h-14 flex items-center justify-center rounded-lg"
              >
                <span
                  v-if="dashboardData.nextWorkout.workout_type === 'easy_run'"
                  >🏃</span
                >
                <span
                  v-else-if="
            ...
            <div v-else class="text-center text-muted-foreground py-5 text-sm">
              <p>
                No active workouts found. Maybe you completed your plan?
                Excellent job!
              </p>
            </div>
          </UiCardContent>
        ...
        <UiCard>
          <UiCardHeader>
            <UiCardTitle
              >Week {{ dashboardData.currentWeekNum }} Overview</UiCardTitle
            >
            <UiCardDescription
              >Scheduled sessions for your current training
              block.</UiCardDescription
            >
          </UiCardHeader>
          <UiCardContent>
            <div
              class="grid grid-cols-[repeat(auto-fit,minmax(110px,1fr))] gap-2"
            >
              <div
              ...
              >
                ...
                <div
                  class="font-medium text-xs whitespace-nowrap overflow-hidden text-ellipsis w-full"
                >
                  {{ w.title }}
                </div>
      ...
      <div class="flex flex-col gap-6">
        ...
        <UiCard>
          <UiCardHeader>
            <UiCardTitle
              >Target:
              {{ dashboardData.athlete?.raceDistance }} Race</UiCardTitle
            >
          </UiCardHeader>
          <UiCardContent>
            <div class="flex flex-col items-center my-2">
              ...
              <span
                class="text-xs text-muted-foreground uppercase tracking-wider mt-1.5"
              >
                Days to Race
              </span>
            </div>
            ...
            <div class="grid grid-cols-2 gap-3 mt-4">
              <div
                class="bg-muted/50 border border-border rounded-lg px-3 py-3 text-center flex flex-col gap-1"
              >
              ...
              >
                <span class="font-semibold text-sm">
                  ...
                  {{ dashboardData.totalWorkoutsCount }}
                </span>
        ...
        <UiCard>
          <UiCardHeader>
            ...
            <UiCardDescription
              >Latest synced entries from your Strava
              ...
              >
                <div class="flex justify-between items-start gap-3">
                  <div>
                    ...
                    <span class="text-xs text-muted-foreground">
                      {{ formatDate(act.start_date, 'ddd, MMM DD') }}
                    </span>
                  </div>
                  <div class="flex gap-1.5">
                    <UiBadge variant="secondary" class="text-[0.6rem]">{{
                      act.sport_type
                    }}</UiBadge>
                    <UiBadge
                ...
                <div class="grid grid-cols-4 gap-2 border-t border-border pt-3">
                  <div>
                    <span class="text-[0.65rem] text-muted-foreground block"
                      >Dist</span
                    >
